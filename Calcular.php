...
if (isset($_POST["btncalcular"])){
    ...
    $objNota1 = new Nota1( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    $objNota2 = new Nota2( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    $objNota3 = new Nota3( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    $objNota4 = new Nota4( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    $objNota5 = new Nota5( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    $objTotal = new Total( $nota1, $nota2,$nota3,$nota4,$nota5,$total);
    ...
    if ($objTotal->calcularTotal()<1){
        ...
        $precio=500000;
        $ptotal=$precio*0.5;
        echo "<b>La valor a pagar :<br>".$ptotal."<br>";
