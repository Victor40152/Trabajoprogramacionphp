...
<html>
    <head>
        ...
        <title>Ejercicio Final programación php</title>
        <script>
    ...
    <body>
        ...
        <form name="form1">
            <p>Nota del Taller 1 (20%)
                <input type="text" name="txttaller1" id="txtxttaller1">
            </p>
            <p>Nota del Taller 2 (15%)
                ...
                <p>
                        ...
                        onclick="proceso($('#txttaller1').val(),$('#txttxttaller2').val(),$('#txtcuestionario1').val(),
